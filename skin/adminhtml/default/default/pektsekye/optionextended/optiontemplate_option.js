    ...
    var layout = layoutSelect.getValue();  
	  ...
	  switch (type){
		  case "radio":
			  ...
			  layoutSelect.options[5] = new Option(this.list, "list");
	      switch (layout){     
