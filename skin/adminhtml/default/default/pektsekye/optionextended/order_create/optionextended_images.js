...
<li>
	<label for="options_88_3">
			<img onclick="optionExtendedInstances[optionExtendedInstanceId].popup(88, 192)" class="optionextended-image" src="http://...jpg">
	</label>
	<span class="content">
		<label for="options_88_3">
			TITLE HERE ...
			...
			if (type == 'radio' || type == 'select-one') {
				if (this.config[0][optionId][1] == 'swap' || this.config[0][optionId][1] == 'pickerswap'){	
					...
					if (this.config[0][optionId][2] && image.style.cursor != 'pointer'){			
						...
						var popupJs = this.imagePopupTemplate.evaluate({'url' : '\'' + this.imageDirUrl + '\'+optionExtendedInstances[optionExtendedInstanceId].config[1][optionExtendedInstances[optionExtendedInstanceId].o[' + optionId + '].value][0]'});						
