        ...
        akordeon: function (options) {
            ...
            return this.each(function () {
                ...
                $('.akordeon-item', akordeon).each(function () {
                    ...
                    if (settings.buttons)
                        $(this).find('.akordeon-item-head-container').prepend('<div class="akordeon-icon"><span class="span-open">' + collapseText + '</span></div>');
                        $('.akordeon-item:first').find('.akordeon-item-head-container').find('span').removeClass('span-open').addClass('span-close');
                });
                $('.akordeon-item').find('.akordeon-item-head-container').find('span').on('click',function(){
                    $(this).toggleClass('span-open').toggleClass('span-close'); 
                });
