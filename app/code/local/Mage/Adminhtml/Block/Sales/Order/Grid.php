...
class Mage_Adminhtml_Block_Sales_Order_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
  ...
  protected function _prepareCollection()
            {
               /**$collection = Mage::getResourceModel($this->_getCollectionClass());
                ...
                //we changed mysql query, we added inner join to order table
                $collection->getSelect()->join(
                        array( 'order' => $resource->getTableName('sales/order') ),
                        'main_table.entity_id=order.entity_id', 
                        array( 'weiss_sap_increment_id' => 'weiss_sap_increment_id' ), 
                        null,
                        'left'
                    );
 ...
 $this->addColumn('sap_increment_id', array(
                    'header' => Mage::helper('sales')->__('sap increment id'),
                    'index' => 'sap_increment_id',
                    'filter_index' => 'order.sap_increment_id'
                ));

/** $this->addColumn('weiss_sap_increment_id', array(
                    'header' => Mage::helper('sales')->__('N Commmande SAP'),
                    'index' => 'weiss_sap_increment_id',
                    'filter_index' => 'order.weiss_sap_increment_id'
                ));**/
        ...
        $this->addColumn('created_at', array(
		 ...
		 $this->addColumn('company', array(
            'header' => Mage::helper('sales')->__('Raison sociale'),
