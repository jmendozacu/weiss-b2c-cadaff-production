...
class Weiss_MultiSales_Model_Validator extends Mage_SalesRule_Model_Validator
{
    ...
    public function process(Mage_Sales_Model_Quote_Item_Abstract $item)
    {
        ...
        foreach ($this->_getRules() as $rule) {
            ...
            if($quote->getIsMultiShipping()){
                ...
                $discountAmount = $qty*(($itemPrice * $percentKey)/100);
                $baseDiscountAmount = $qty* (($itemPrice * $percentKey)/100);
            }
