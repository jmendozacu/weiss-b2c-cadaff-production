...
class Trego_Blog_Helper_Toolbar extends Mage_Core_Block_Abstract
{
    ...
    { 
        ...
        $block->setChild('trego_blog_comments_toolbar', $toolbar);
    }
    ...
    {
        $block = $this->getToolbarParentBlock()->getLayout()->getBlock('trego_blog_list_toolbar');
