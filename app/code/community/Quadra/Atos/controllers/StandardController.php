        ...
        switch ($response['response_code']) {
            case '00':
                ...
                if ($response['return_context']) {
					...
					Mage::getSingleton('core/session')->setTransactionId($response['transaction_id']);
					Mage::getSingleton('core/session')->setCardType($response['payment_means']);
					Mage::getSingleton('core/session')->setCardNumber($response['card_number']);
