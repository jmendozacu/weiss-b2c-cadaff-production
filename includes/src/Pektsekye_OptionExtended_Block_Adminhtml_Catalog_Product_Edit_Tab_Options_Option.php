...
{   
    ...
    public function getCheckboxScopeHtml($id, $name, $checked=true, $select_id = -1)
    {
      ...
      $checkbox = '<input type="checkbox" id="'. $inputId .'_use_default" class="product-option-scope-checkbox" name="'. $inputName .'" value="1" '. ($checked ? 'checked="checked"' : '') .'  onclick="optionExtended.setScope(this, \''. $inputId .'\', \''. $name .'\')"/>'.
