...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	<header class="entry-header">
		...
		<?php $thumb_img = get_post_meta($post->ID, 'post_thumb'); ?>
		...
		<?php elseif ( $thumb_img && trego_catch_that_image($thumb_img[0]) ) : ?>

		<div class="entry-thumbnail">
 			<img src="<?php echo trego_catch_that_image($thumb_img[0]); ?>" alt="" />
		</div>
